...
void OnZoom_Sinc(char imageFileName[], int rcxres, int rcyres, double m_Bandwidth, double m_TheSamplingRate);
void OnFourierTransform(char imageFilename[], int rcxres, int rcyres);

// declare a class by the name 'Sinc_Int_2022'
class Sinc_Int_2022 {
...
void Sinc_Int_2022::allocateData() { // allocate data
...
void Sinc_Int_2022::save() { // saveImages
